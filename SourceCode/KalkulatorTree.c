...
void editInfix(String infix){
    ...
    while(counter1<ukuran){
		...
		if(infix[counter1] == '(' && counter1 != 0 && infix[counter1-1] != '+' && infix[counter1-1] != '-' && infix[counter1-1] != '*' && infix[counter1-1] != '/' 
			&& infix[counter1-1] != ':' && infix[counter1-1] != '^' && infix[counter1-1] != 'v' && infix[counter1-1] != 's' && infix[counter1-1] != 'c' && infix[counter1-1] != 't'
			&& infix[counter1-1] != 'p' && infix[counter1-1] != 'l'){
